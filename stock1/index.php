...
<body class="container">
    <div class="form-group">
        <div class="text-center text-primary bg-success rounded-3">
            <em>
        ...
        <div class="d-flex justify-content-end">
            <button class="btn btn-success" onclick="window.location.href='commande.php';">Retour</button>
        </div>
    </div>
</body>
